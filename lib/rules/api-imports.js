...
module.exports = {
    meta: {
        ...
        messages : {
            ...
            [TESTING_PUBLIC_ERROR] : 'Тестовые данные необходимо импортировать только в файлы с тестовыми расширениями.'
        },
...
ß
                ...
                if (isTestingPublicApi) {
                    ...
                    if (!isCurrentFileTesting) {
                        context.report({ 
                            node,
                        messagesId: TESTING_PUBLIC_ERROR
                        });
                    }
                }
            },
